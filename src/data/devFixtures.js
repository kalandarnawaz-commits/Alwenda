/**
 * DEVELOPMENT-ONLY FIXTURES. This file must never be imported by anything
 * except src/data/mockData.js's isFixturesAllowed() gate, and never
 * rendered to a real user. Every record here is fabricated seed/demo
 * content — invented businesses, listings, professionals, reviews,
 * notifications, messages, and reputation numbers — that exists purely so
 * local development and the automated test suite have something to look
 * at. See docs/qa/production-data-policy.md.
 *
 * scripts/validate-production-data-safety.mjs asserts this file is never
 * copied into a production build, and src/config.js's isFixturesAllowed()
 * ensures none of it is ever assigned into a rendered array/object outside
 * an explicitly-configured "development" or "test" APP_ENV.
 */

export const FIXTURE_importSources = [
  {
    id: "osm",
...
export const FIXTURE_businessClaims = [
  {
    id: "claim-001",
...
export const FIXTURE_cityGraph = {
  places: 84,
  businesses: 52,
  professionals: 22,
  listings: 128,
...
export const FIXTURE_reputationProfile = {
  name: "Alex Walker",
...
export const FIXTURE_profileReviews = [
...
export const FIXTURE_feedPosts = [
  {
    id: 1,
...
export const FIXTURE_liveAroundYou = [
...
export const FIXTURE_earnToday = [
...
export const FIXTURE_exploreHighlights = [
...
export const FIXTURE_alwenRecommendations = [
...
export const FIXTURE_serviceProfessionals = [
  {
    id: 501,
...
export const FIXTURE_helpRequests = [
  {
    id: 601,
...
export const FIXTURE_reservations = [
  {
    id: 401,
...
export const FIXTURE_alwenListingDraft = {
...
export const FIXTURE_alwenBusinessDraft = {
...
export const FIXTURE_messageThreads = [
  {
    id: 901,
    type: "professional",
...
export const FIXTURE_adminStats = [
